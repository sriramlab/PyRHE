...
do
  ...
  cmd="python /u/home/j/jiayini/project-sriram/PyRHE/run_original.py --geno ${geno_path} --pheno ${pheno_path} -c ${covariate_path} -k ${num_vec} -b ${num_bin} -jn ${num_block} --output ${output}"
